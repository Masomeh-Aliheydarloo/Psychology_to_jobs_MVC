...
export const ClassATestCom: React.FC<LoginProps> = ({ onLogin, showresult }) => {
  ...
  useEffect(() => {
    const fetchQuestion = async () => {
      ...
      try {
        ...
        const response = await get("/api/classAtest");
  ...
  const selectQ = async (event: React.ChangeEvent<HTMLInputElement>, qlist: Question) => {
    ...
    setSQ(SQ.filter((q) => q.QAid !== qlist.QAid));

    let newQ: SelectedQuestion = { QAid: qlist.QAid, Score: parseInt(event.target.value), QAnumber: qlist.QAnumber };
  ...
  function score() {
    ...
    const list1 = SQ.filter((q) => q.QAnumber === 1);
    if (list1.length != 0) sum = sum + Number(list1[list1.length - 1].Score);

    console.log("list1", list1);
    console.log("sum", sum);

    const list2 = SQ.filter((q) => q.QAnumber === 2);
    //console.log("score", list2[list2.length - 1].Score);
    if (list2.length !== 0) {
      if (list2[list2.length - 1].Score === 1) { sum = sum + 6 }
      else if (list2[list2.length - 1].Score === 2) { sum = sum + 5 }
      else if (list2[list2.length - 1].Score === 3) { sum = sum + 4 }
      else if (list2[list2.length - 1].Score === 4) { sum = sum + 3 }
      else if (list2[list2.length - 1].Score === 5) { sum = sum + 2 }
      else if (list2[list2.length - 1].Score === 6) { sum = sum + 1 }
    }

    console.log("list2", list2);
    console.log("sum", sum);

    const list3 = SQ.filter((q) => q.QAnumber === 3);
    ...
    const list4 = SQ.filter((q) => q.QAnumber === 4);
    if (list4.length != 0) sum = sum + Number(list4[list4.length - 1].Score);

    console.log("list4", list4);
    console.log("sum", sum);

    const list5 = SQ.filter((q) => q.QAnumber === 5);
    if (list5.length != 0) sum = sum + Number(list5[list5.length - 1].Score);

    console.log("list5", list5);
    console.log("sum", sum);


    const list6 = SQ.filter((q) => q.QAnumber === 6);
    ...
    const list7 = SQ.filter((q) => q.QAnumber === 7);
    ...
    const list8 = SQ.filter((q) => q.QAnumber === 8);
    //  console.log("score", list8[list8.length - 1].Score);
    if (list8.length != 0) {
      if (list8[list8.length - 1].Score === 1) { sum = sum + 6 }
      else if (list8[list8.length - 1].Score === 2) { sum = sum + 5 }
      else if (list8[list8.length - 1].Score === 3) { sum = sum + 4 }
      else if (list8[list8.length - 1].Score === 4) { sum = sum + 3 }
      else if (list8[list8.length - 1].Score === 5) { sum = sum + 2 }
      else if (list8[list8.length - 1].Score === 6) { sum = sum + 1 }
    }
    console.log("list8", list8);
    console.log("sum", sum);

    const list9 = SQ.filter((q) => q.QAnumber === 9);
    //console.log("score", list9[list9.length - 1].Score);
    if (list9.length != 0) {
    ...
    const list10 = SQ.filter((q) => q.QAnumber === 10);
    // console.log("score", list10[list10.length - 1].Score);
    if (list10.length != 0) {
      if (list10[list10.length - 1].Score === 1) { sum = sum + 6 }
      else if (list10[list10.length - 1].Score === 2) { sum = sum + 5 }
      else if (list10[list10.length - 1].Score === 3) { sum = sum + 4 }
      else if (list10[list10.length - 1].Score === 4) { sum = sum + 3 }
      else if (list10[list10.length - 1].Score === 5) { sum = sum + 2 }
      else if (list10[list10.length - 1].Score === 6) { sum = sum + 1 }
    ...
    const list11 = SQ.filter((q) => q.QAnumber === 11);
    if (list11.length != 0) sum = sum + Number(list11[list11.length - 1].Score);

    console.log("list11", list11);
    console.log("sum", sum);

    const list12 = SQ.filter((q) => q.QAnumber === 12);
    if (list12.length != 0) sum = sum + Number(list12[list12.length - 1].Score);

    console.log("list12", list12);
    console.log("sum", sum);

    const list13 = SQ.filter((q) => q.QAnumber === 13);
    if (list13.length != 0) sum = sum + Number(list13[list13.length - 1].Score);

    console.log("list13", list13);
    console.log("sum", sum);

    const list14 = SQ.filter((q) => q.QAnumber === 14);
    // console.log("score", list14[list14.length - 1].Score);
    if (list14.length != 0) {
      if (list14[list14.length - 1].Score === 1) { sum = sum + 6 }
      else if (list14[list14.length - 1].Score === 2) { sum = sum + 5 }
      else if (list14[list14.length - 1].Score === 3) { sum = sum + 4 }
      else if (list14[list14.length - 1].Score === 4) { sum = sum + 3 }
      else if (list14[list14.length - 1].Score === 5) { sum = sum + 2 }
      else if (list14[list14.length - 1].Score === 6) { sum = sum + 1 }

    }
    console.log("list14", list14);
    console.log("sum", sum);

    const list15 = SQ.filter((q) => q.QAnumber === 15);
    if (list15.length != 0) sum = sum + Number(list15[list15.length - 1].Score);

    console.log("list15", list15);
    console.log("sum", sum);

    const list16 = SQ.filter((q) => q.QAnumber === 16);
    if (list16.length != 0) sum = sum + Number(list16[list16.length - 1].Score);

    console.log("list16", list16);
    console.log("sum", sum);

    const list17 = SQ.filter((q) => q.QAnumber === 17);
    if (list17.length != 0) sum = sum + Number(list17[list17.length - 1].Score);

    console.log("list17", list17);
    console.log("sum", sum);

    const list18 = SQ.filter((q) => q.QAnumber === 18);
    //   console.log("score", list18[list18.length - 1].Score);
    if (list18.length != 0) {
      if (list18[list18.length - 1].Score === 1) { sum = sum + 6 }
      else if (list18[list18.length - 1].Score === 2) { sum = sum + 5 }
      else if (list18[list18.length - 1].Score === 3) { sum = sum + 4 }
      else if (list18[list18.length - 1].Score === 4) { sum = sum + 3 }
      else if (list18[list18.length - 1].Score === 5) { sum = sum + 2 }
      else if (list18[list18.length - 1].Score === 6) { sum = sum + 1 }
    }
    console.log("list18", list18);
    console.log("sum", sum);


    const list19 = SQ.filter((q) => q.QAnumber === 19);
    if (list19.length != 0) sum = sum + Number(list19[list19.length - 1].Score);

    console.log("list19", list19);
    console.log("sum", sum);

    const list20 = SQ.filter((q) => q.QAnumber === 20);
    if (list20.length != 0) sum = sum + Number(list20[list20.length - 1].Score);

    console.log("list20", list20);
    console.log("sum", sum);

    const list21 = SQ.filter((q) => q.QAnumber === 21);
  ...
  return (<>
    <div className="pb-5 pt-5 pl-8 pr-8">
      <p className="  font-roboto  text-base font-semibold md:text-l  text-text-error">
        CLASS A: ASSERTION OF NEEDS (IDENTIFICATION & EXPRESSION)</p><p>
    ...
    <div className="w-full max-w-screen-sm md:max-w-screen-md mx-auto px-4 " >
      ...
      <fieldset className="  text-center space-y-8 justify-center items-center ">
        {Q.map((qlist) => (
          ...
          <div key={qlist.QAid} className="  justify-center items-center    p-4 rounded-md hover:text-text_light  text-text_black dark:text-text_white shadow-sm transition duration-200">
            <legend className="font-roboto font-normal md:font-medium text-base mb-4" > {qlist.c}/21.{qlist.QAtitle}  </legend>
            <div className="flex flex-wrap justify-center items-center gap-5 md:gap-12 mt-4">



              <input type="radio" className="  cursor-pointer w-14 h-14  mr-4  " name={`question-${qlist.QAnumber}`} id={`disagree-q1-3-${qlist.QAid}`} value={1} onChange={(event) => selectQ(event, qlist)} />


              <input type="radio" className=" cursor-pointer w-10 h-10 mr-4" name={`question-${qlist.QAnumber}`} id={`disagree-q1-2-${qlist.QAid}`} value={2} onChange={(event) => selectQ(event, qlist)} />


              <input type="radio" className="cursor-pointer w-8 h-8 mr-4" name={`question-${qlist.QAnumber}`} id={`neutral-q1-${qlist.QAid}`} value={3} onChange={(event) => selectQ(event, qlist)} />


              <input type="radio" className="cursor-pointer w-8 h-8 mr-4" name={`question-${qlist.QAnumber}`} id={`agree-q1-2-${qlist.QAid}`} value={4} onChange={(event) => selectQ(event, qlist)} />


              <input type="radio" className="cursor-pointer w-10 h-10 mr-4" name={`question-${qlist.QAnumber}`} id={`agree-q1-3-${qlist.QAid}`} value={5} onChange={(event) => selectQ(event, qlist)} />

              <input type="radio" className="  cursor-pointer w-14 h-14  mr-4 " name={`question-${qlist.QAnumber}`} id={`disagree-q1-4-${qlist.QAid}`} value={6} onChange={(event) => selectQ(event, qlist)} />
