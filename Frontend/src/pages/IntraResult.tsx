...
import image from '../assets/Intra.webp';

import storage from '../components/LocalStorage';
import { post } from "../components/api";
import { IntraResultCom } from '../components/IntraResultCom';
...
const IntraResult: React.FC<LoginProps> = ({ onLogin }) => {
    ...
    return (
        <>
           ...
           dark:bg-dark_bg_body justify-center  ">
                ...
                <img className="rounded-xl h-80 w-full " src={image} alt="IntraTestResult"   ></img>
                <p className="absolute  text-text_white   left-15 top-60 text-2xl lg:text-4xl font-bold  ">Intra-Personal Result</p>
            </div>
            <div className="box-content  ml-auto mr-auto lg:w-[65%]  bg-light_bg_body 
           dark:bg-dark_bg_body justify-center" >
               
                {(Result === 1) && (<IntraResultCom  C={C} N={N} O={O} />)}
