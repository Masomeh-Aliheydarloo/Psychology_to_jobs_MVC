    ...
    return (
        <>
           ...
           dark:bg-dark_bg_body justify-center  ">
                ...
                <img className="rounded-xl h-80 w-full " src={image} alt="InterTest"   ></img>
                <p className="absolute  text-text_white   left-15 top-60 text-2xl lg:text-4xl font-bold  ">Inter-Personal Test</p>
            </div>
